...
describe('settingsStore', () => {
  ...
  it('save/load 往返', async () => {
    ...
    await saveSettings(s, { urlFilterEnabled: false, blurHideEnabled: false, clipboardClearEnabled: false, popupCloseDelayMs: 5000, syncEnabled: true, themeMode: 'dark', themeColor: 'teal', lockOnRestart: false, lockIdleMinutes: 15, lockOnSystemLock: false, backupKdfProfile: 'fast', tagFilterMode: 'any', rememberTagFilter: false, lastTagFilterIds: [], locale: 'zh' })
    expect(await loadSettings(s)).toEqual({ urlFilterEnabled: false, blurHideEnabled: false, clipboardClearEnabled: false, popupCloseDelayMs: 5000, syncEnabled: true, themeMode: 'dark', themeColor: 'teal', lockOnRestart: false, lockIdleMinutes: 15, lockOnSystemLock: false, backupKdfProfile: 'fast', tagFilterMode: 'any', rememberTagFilter: false, lastTagFilterIds: [], locale: 'zh' })
  })
