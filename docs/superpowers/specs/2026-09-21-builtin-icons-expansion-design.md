...
> 落地裁定（2026-09-22）：接受 **218 项**（非"300+"）。候选清单 167 项 + 既有 111 项 − 重叠 19 项
> − 上游已下架 41 项，算术上限即 218，数据质量优先于数量，不再为凑数放宽收录标准；
> README 已如实记录 218 项与 58 条别名。体积实测 231KB（gzip 约 95KB），满足 <300KB。
